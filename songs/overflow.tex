...
\refrain{
	...
	Only see the \chord{D}leak when your memory’s low\chord{Em} \\
	Only know your \chord{C}buffers when they overflow\chord{G} \ \ \chord{D} \\
	Only know SS\chord{C}L when it broke somehow\chord{G} \\
	Only lock your \chord{D}ports when the problems grow\chord{Em} \\
	Only know your \chord{C}buffers when they overflow\chord{G} \ \ \chord{D} \\
	And they overflow} \textcolor{\chordcolor}{Em C D Hm Em C D} \\

\chord{Em}Staring at the bottom of your \chord{C}class  \\
Hoping one\chord{D} day you’ll make the tests \chord{Hm}pass \\
But they run slow\chord{Em} and they fail so\chord{C} fast \chord{D} \\
You’d \chord{Em}see it if you looked real close\chord{C} \\
But time is spar\chord{D}se and the pressure grows\chord{Hm} \\
Everything you code\chord{Em} is insecu\chord{C}re \chord{D} \\
