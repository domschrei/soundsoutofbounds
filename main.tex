...
\newcommand\songinfo[2]{\begin{textblock}{0.5}(0.41,0.065)
	...
	\def\maketitle{
		\vspace{10cm}
		\begin{center}
			\begin{overpic}[width=12cm]{Titel_ohneSchrift.png}
		...
		\begin{document}
			...
			\chord{C} Applaus, Appla\chord{e}us \\
			\chord{G} Für \chord{D}deine Sorte \\
			\chord{C} Mein Herz geht auf\chord{e} \ \ \chord{G} \\
			\chord{D}Wenn du lädst \\
			\chord{C} Stack Overflow	\chord{e} \\
			Du \chord{G}hilfst mir, guten \chord{D}Code zu schreiben \\
			\chord{C} Hör niemals damit auf!\chord{e} \\
			Ich \chord{G}wünsch mir so sehr \\
			Niemand \chord{D}kauft dich jemals auf \\
			...
			Wenn du lädst \\
			Stack Overflow \\
			Du hilfst mir, guten Code zu schreiben \\
			Hör niemals damit auf! \\
			Ich wünsch mir so sehr \\
			Niemand kauft dich jemals auf \\
			...
			\chord{a}Git does seem so easy for that \chord{e}other guy \\
			but all\chord{d} that I can see\chord{G} is just the giant \chord{C}branching tree. \chord{G} \\
			I \chord{C}pull and push \chord{G}every time \\
			still \chord{a}merging conflicts haunt me every \chord{e}second line \\
			...
			Git does seem so easy for that other guy \\
			but all that I can see is just the giant branching tree. \\
			I pull and push every time \\
			still, merging conflicts haunt me every second line \\
			...
			I’m your  \chord{C}help with IT \\
			I’ll  \chord{G}fix it, you will see \\
			I know you  \chord{a}wouldn’t get it any other \chord{F}way \\
			...
			I’m your help with IT \\
			I’ll fix it, you will see \\
			You know you wouldn’t get it any other way \\
			...
			\chord{A}Python types are slack \\
			And the NoneType apparently \chord{D}cannot quack\footnote{\scriptsize \textit{Duck Typing}; Typen werden nur durch das Vorhandensein bestimmter Attribute oder Methoden (\glqq object.quack()\grqq) beschrieben. Erhält ein Objekt wegen eines Fehlers den Wert \texttt{None}, wird dies oft erst bemerkt, wenn versucht wird, darauf Aktionen auszuführen. Die Fehlermeldung lautet dann dass für \texttt{NoneType} diese Aktion undefiniert ist.} \ \chord{E} \\
			I'm writing fast\chord{A} \\
			The execution time is pretty decent, too\chord{D} \ \ \chord{E} \\
			
			And \chord{D}as the feeling grows \\
			That it works \chord{G}fine, I suppose \\
			Compi\chord{A}lation seems dead \\
			\chord{G} I'm coding \chord{D}Python instead\chord{A} \\
			...
			\chord{e} Another sma\chord{C}rtphone purchased \\
			child\chord{G} is slowly ta\chord{D}ken \\
			...
			they drank delicious Mate\footnote{Eine der Desktopumgebungen von Linux Mint} tea \\ 
			...
			\pagebreak
				...
				I’m a \chord{d}Word user \chord{G}trying TeX\footnote{Auszusprechen wie \textit{tech}, nicht \textit{teks}} \chord{a} \\
				...
				I guess\chord{G} it's easier the more you \chord{A}know \\
				...
				\chord{d} Well, TeX is \chord{G}not as hard as \chord{a}someone said \\
				...
				But it \chord{F}works, no matter \chord{G}what they say \chord{a} \\
				It just \chord{F}works, no matter \chord{G}what they say \chord{a} \\
				Yeah it \chord{F}works, no matter \chord{G}what they say \chord{a} \\
				And it’s \chord{F}great, no matter \chord{G}what they say \chord{a} \\
				...
				Aaaah – \\
				\chord{d}That’s what ba\chord{G}ckslash means, all\chord{e} the code is clear \chord{a} to me, \\
				With some \chord{d}dollars signs \chord{G}it will work\chord{a} \\
				Aaaah \chord{d}– \\
				It’s compi\chord{G}ling now, what\chord{e} a pretty do\chord{a}cument \\
