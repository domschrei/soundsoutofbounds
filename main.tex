...
\newcommand\songinfo[2]{\begin{textblock}{0.5}(0.41,0.065)
	...
	\def\maketitle{
		...
		\begin{document}
			...
			\songinfo{Passenger – Let Her Go}{Dominik Schreiber}
			...
			Staring at the bottom of your class  \\
            Hoping one day you’ll make the tests pass \\
            But they run slow and they fail so fast \\
            You’d see it if you looked real close \\
            But time is sparse and the pressure grows \\
            Everything you code is insecure \\
...
S2 				I’m a Word user trying \TeX \\
				...
				Aaaah -- \chord{d}That’s what ba\chord{G}ckslash means, all\chord{e} the code is clear \chord{a} to me, \\
